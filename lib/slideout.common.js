...
/* harmony default export */ var computed = ({
  computed: {
    ...
    layoutStyle: function layoutStyle() {
      ...
      var size = this.resizeValue > 0 ? "".concat(this.resizeValue, "px") : this.sizeWithUnit;
  ...
  methods: {
    ...
    mouseMoveHandler: function mouseMoveHandler(e) {
      ...
      requestAnimationFrame(function () {
        _this2.resizeValue = newSize < _this2.minSize ? _this2.minSize : newSize;
      });
      this.$nextTick(function () {
        _this2.$emit('resize', {
