...
// CONCATENATED MODULE: ./src/components/Template.vue?vue&type=template&id=6ad7790b&
...
/* harmony default export */ var methods = ({
  methods: {
    ...
    emitOpenEvent: function emitOpenEvent() {
      ...
      setTimeout(function () {
        _this3.$emit('open', _this3.$refs.layout);
