...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"698aaf6b-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/Template.vue?vue&type=template&id=08027bfc&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (!_vm.renderWhenVisible || _vm.isVisible)?_c('div',{staticClass:"slideout",class:_vm.containerClasses,style:(_vm.containerStyle),attrs:{"tabindex":"0"}},[(_vm.showMask)?_c('div',{staticClass:"slideout-mask",style:(_vm.maskStyle),on:{"click":_vm.onMaskClick}}):_vm._e(),_c('div',{ref:"layout",staticClass:"slideout-layout",style:(_vm.layoutStyle)},[(_vm.allowResize && !_vm.isFullscreen && !_vm.isSizeFixed)?_c('div',{staticClass:"slideout-drag-handle",on:{"mousedown":_vm.mouseDownHandler}}):_vm._e(),(_vm.showHeader)?_c('div',{staticClass:"slideout-header",style:(_vm.headerStyle)},[_vm._t("header",[_c('div',{staticClass:"slideout-title-text"},[_vm._v("\n          "+_vm._s(_vm.title)+"\n        ")]),_c('div',{ref:"buttons",staticClass:"slideout-title-buttons"},[_c('span',{staticClass:"slideout-custom-buttons"},[_vm._t("btn")],2),_c('span',{staticClass:"slideout-default-buttons"},[(_vm.showFullscreen)?_c('button',{staticClass:"slideout-btn-fullscreen",on:{"click":function($event){return _vm.toggleFullscreen()}}},[_c('icon-fullscreen'),_c('icon-fullscreen-exit')],1):_vm._e(),(_vm.showClose)?_c('button',{staticClass:"slideout-btn-close",on:{"click":function($event){return _vm.tryClose()}}},[(_vm.arrowButton)?_c('icon-arrow'):_c('icon-cross')],1):_vm._e()])])],{"title":_vm.title})],2):_vm._e(),_c('div',{staticClass:"slideout-content",style:(_vm.contentStyles)},[_vm._t("default")],2),_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.$slots.footer),expression:"$slots.footer"}],staticClass:"slideout-footer"},[_vm._t("footer")],2)])]):_vm._e()}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/Template.vue?vue&type=template&id=08027bfc&
...
/* harmony default export */ var computed = ({
  computed: {
    ...
    containerClasses: function containerClasses() {
      ...
      return _ref = {}, _defineProperty(_ref, this.customClass || '', true), _defineProperty(_ref, "slideout-dock-".concat(this.dockOn), true), _defineProperty(_ref, 'slideout-visible', this.activeVisibleClass), _defineProperty(_ref, 'slideout-enable-animation', !this.mousedown && !this.disableAnimation), _defineProperty(_ref, 'slideout-show-header', this.showHeader), _defineProperty(_ref, 'slideout-show-footer', this.$slots.footer), _defineProperty(_ref, 'slideout-allow-resize', this.allowResize), _defineProperty(_ref, 'slideout-fixed', this.isFixed), _defineProperty(_ref, 'slideout-fullscreen', this.isFullscreen), _defineProperty(_ref, 'slideout-autosize', this.isAutoSize), _ref;
    },
    // 头部样式
...
/* harmony default export */ var watch = ({
  watch: {
    ...
    fullscreen: function fullscreen(_fullscreen) {
      if (_fullscreen === this.isFullscreen) {
        return;
      }
    ...
    isVisible: function isVisible(v) {
      ...
      this.$nextTick(function () {
        _this._removeKeyboardEvent();

        if (v) {
          _this._bindKeyboardEvent();
        }
      });
