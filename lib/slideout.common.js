...
var component = normalizeComponent(
  script,
  IconArrowvue_type_template_id_6f49621a_render,
  IconArrowvue_type_template_id_6f49621a_staticRenderFns,
  false,
  null,
  null,
  null
...
var IconCross_component = normalizeComponent(
  IconCross_script,
  IconCrossvue_type_template_id_4d915138_render,
  IconCrossvue_type_template_id_4d915138_staticRenderFns,
  false,
  null,
  null,
  null
...
var IconFullscreen_component = normalizeComponent(
  ...
  IconFullscreenvue_type_template_id_5d730204_render,
  IconFullscreenvue_type_template_id_5d730204_staticRenderFns,
  false,
  null,
  null,
  null
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"b378ac2a-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/icon/IconFullscreenExit.vue?vue&type=template&id=30663913&
var IconFullscreenExitvue_type_template_id_30663913_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('svg',{attrs:{"version":"1.1","viewBox":"0 0 1024 1024","xmlns":"http://www.w3.org/2000/svg","width":"16","height":"16"}},[_c('path',{attrs:{"d":"M391 240.9c-0.8-6.6-8.9-9.4-13.6-4.7l-43.7 43.7L200 146.3c-3.1-3.1-8.2-3.1-11.3 0l-42.4 42.3c-3.1 3.1-3.1 8.2 0 11.3L280 333.6l-43.9 43.9c-4.7 4.7-1.9 12.8 4.7 13.6L401 410c5.1 0.6 9.5-3.7 8.9-8.9L391 240.9zM401.1 614.1L240.8 633c-6.6 0.8-9.4 8.9-4.7 13.6l43.9 43.9L146.3 824c-3.1 3.1-3.1 8.2 0 11.3l42.4 42.3c3.1 3.1 8.2 3.1 11.3 0L333.7 744l43.7 43.7c4.7 4.7 12.8 1.9 13.6-4.7l18.9-160.1c0.6-5.1-3.7-9.4-8.8-8.8zM622.9 409.9L783.2 391c6.6-0.8 9.4-8.9 4.7-13.6L744 333.6 877.7 200c3.1-3.1 3.1-8.2 0-11.3l-42.4-42.3c-3.1-3.1-8.2-3.1-11.3 0L690.3 279.9l-43.7-43.7c-4.7-4.7-12.8-1.9-13.6 4.7L614.1 401c-0.6 5.2 3.7 9.5 8.8 8.9zM744 690.4l43.9-43.9c4.7-4.7 1.9-12.8-4.7-13.6L623 614c-5.1-0.6-9.5 3.7-8.9 8.9L633 783.1c0.8 6.6 8.9 9.4 13.6 4.7l43.7-43.7L824 877.7c3.1 3.1 8.2 3.1 11.3 0l42.4-42.3c3.1-3.1 3.1-8.2 0-11.3L744 690.4z"}})])}
var IconFullscreenExitvue_type_template_id_30663913_staticRenderFns = []


// CONCATENATED MODULE: ./src/components/icon/IconFullscreenExit.vue?vue&type=template&id=30663913&
...
var IconFullscreenExit_component = normalizeComponent(
  ...
  IconFullscreenExitvue_type_template_id_30663913_render,
  IconFullscreenExitvue_type_template_id_30663913_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var components_component = ({
  ...
  computed: {
    ...
    sizeWithUnit: function sizeWithUnit() {
      return typeof this.size === 'number' || !/%$/.test(this.size) ? "".concat(parseInt(this.size), "px") : "".concat(parseInt(this.size), "%");
    },
    // 隐藏时 size 的大小
    hiddenSizeWithUnit: function hiddenSizeWithUnit() {
      return typeof this.size === 'number' || !/%$/.test(this.size) ? "".concat(-parseInt(this.size), "px") : "".concat(-parseInt(this.size), "%");
    },
    // SlideOut 内容样式
    layoutStyle: function layoutStyle() {
      ...
      if (this.isSizeFixed) {
        ...
        style.height = this.isFullscreen ? '100%' : this.size[this.size.length === 1 ? 0 : 1]; // 偏移量，当全屏时偏移量为 0
      ...
      var size = this.isFullscreen ? '100%' : this.resizeValue > 0 ? "".concat(this.resizeValue, "px") : this.sizeWithUnit; // 内容到边的距离

      var distance = this.isVisible || this.disableAnimation ? 0 : this.hiddenSizeWithUnit;
  ...
  methods: {
    ...
    appendComponentTo: function appendComponentTo() {
      ...
      if (typeof target === 'string') {
        ...
        if (!target) {
          throw new Error("SlideOut cannot found the node to append to: ".concat(this.appendTo));
        }
      }
     ...
     */
    getInstance: function getInstance(size) {
      return this.isVisible || this.disableAnimation ? 0 : typeof size === 'number' || !/%$/.test(size) ? "".concat(-parseInt(size), "px") : "".concat(-parseInt(size), "%");
    },
  ...
  mounted: function mounted() {
    // 检查传入的  dock 值是否有效
    var docks = ['top', 'right', 'bottom', 'left'];

    if (this.dock && docks.indexOf(this.dock) === -1) {
      throw new Error("Invalid dock value \"".concat(this.dock, "\", Optional: ").concat(docks.join(','), " "));
    }
...
// EXTERNAL MODULE: ./src/components/slideout.less
var slideout = __webpack_require__("438e");
...
/* harmony default export */ var Templatevue_type_script_lang_js_ = (_objectSpread({
  components: {
    IconArrow: IconArrow,
    IconCross: IconCross,
