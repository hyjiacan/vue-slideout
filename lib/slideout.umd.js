...
/* harmony default export */ var computed = ({
  computed: {
    ...
    containerClasses: function containerClasses() {
      return _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, this.customClass || '', true), "vue-slideout-dock-".concat(this.dockOn), true), 'vue-slideout-visible', this.activeVisibleClass), 'vue-slideout-enable-animation', !this.mousedown && !this.disableAnimation), 'vue-slideout-show-header', this.showHeader), 'vue-slideout-show-footer', this.$slots.footer), 'vue-slideout-allow-resize', this.allowResize), 'vue-slideout-fixed', this.isFixed), 'vue-slideout-fullscreen', this.isFullscreen), 'vue-slideout-autosize', this.isAutoSize);
    },
    // 是否使用固定定位
...
// CONCATENATED MODULE: ./src/components/Template.vue?vue&type=script&lang=js
 /* harmony default export */ var components_Templatevue_type_script_lang_js = (Templatevue_type_script_lang_js); 
...
var Template_component = normalizeComponent(
  components_Templatevue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
